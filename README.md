...
- 本插件的核心逻辑已做成独立项目：[https://github.com/Zhalslar/api-aggregator](https://github.com/Zhalslar/api-aggregator)

- 使用时，打开API聚合器面板进行操作，本地部署时地址默认为[http://127.0.0.1:4141](http://127.0.0.1:4141)， 远程部署的则是[http://ip:port](http://ip:port)，ip为你服务器的ip或域名， port默认为4141，使用时服务器要放行4141端口

- 点击站点池的`快速导入默认项`的按钮 和 API池的`快速导入默认项`的按钮，即可快速体验开发者留给你的预设数据。

- 部分api站点需要密钥，如 倾梦API：<https://api.317ak.cn>， 此站点需前往网页，注册账号，获取ckey密钥。然后在面板的站点池上添加站点，填入配置中的密钥池：“ ckey : xxxxxxxxxxx”

### 面板示例图

推荐用面板管理 API 池资源，插件端仅匹配API, 不再提供管理命令。
<img width="966" height="552" alt="图片" src="https://github.com/user-attachments/assets/66743364-8c2e-4eba-a4a4-57a485d5f232" />

<img width="1904" height="1012" alt="图片" src="https://github.com/user-attachments/assets/46184eba-b975-4628-a1be-f4c84706e509" />
